...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Altair2 server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Altair2 features */
        {"altair2", "masternode", &masternode, true, true, false},
        {"altair2", "listmasternodes", &listmasternodes, true, true, false},
        {"altair2", "getmasternodecount", &getmasternodecount, true, true, false},
        {"altair2", "masternodeconnect", &masternodeconnect, true, true, false},
        {"altair2", "masternodecurrent", &masternodecurrent, true, true, false},
        {"altair2", "masternodedebug", &masternodedebug, true, true, false},
        {"altair2", "startmasternode", &startmasternode, true, true, false},
        {"altair2", "createmasternodekey", &createmasternodekey, true, true, false},
        {"altair2", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"altair2", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"altair2", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"altair2", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"altair2", "getmasternodescores", &getmasternodescores, true, true, false},
        {"altair2", "mnbudget", &mnbudget, true, true, false},
        {"altair2", "preparebudget", &preparebudget, true, true, false},
        {"altair2", "submitbudget", &submitbudget, true, true, false},
        {"altair2", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"altair2", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"altair2", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"altair2", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"altair2", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"altair2", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"altair2", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"altair2", "checkbudgets", &checkbudgets, true, true, false},
        {"altair2", "mnsync", &mnsync, true, true, false},
        {"altair2", "spork", &spork, true, true, false},
        {"altair2", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"altair2", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> altair2-cli " + methodname + " " + args + "\n";
}
