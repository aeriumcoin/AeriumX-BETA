...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Altair2 Core altair2-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  altair2-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded altair2 transaction") + "\n" +
                               "  altair2-tx [options] -create [commands]   " + _("Create hex-encoded altair2 transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded altair2 transaction
