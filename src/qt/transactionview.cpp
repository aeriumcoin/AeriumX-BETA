 ...
 */
    ...
    typeWidget->addItem(tr("Received ATR from zATR"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zATR"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zATR));
...
void TransactionView::setModel(WalletModel* model)
{
    ...
    if (model) {
        ...
        transactionView->setStyleSheet("border:0px; background-color:rgba(255, 255, 255, 0.4); padding-right:2px;");
