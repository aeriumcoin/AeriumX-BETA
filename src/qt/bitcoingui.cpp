                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Altair2 Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Altair2 address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and altair2: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zATR"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Altair2 Core"), this);
    aboutAction->setStatusTip(tr("Show information about Altair2 Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Altair2"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Altair2 addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Altair2 addresses"));
    ...
    openAction->setStatusTip(tr("Open a Altair2: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Altair2 Core help message to get a list with possible Altair2 command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Altair2 Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Altair2 network", "", count));
}
...
{
    QString strTitle = tr("Altair2 Core"); // default title
