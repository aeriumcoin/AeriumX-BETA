...
/** 
    ...
    ****Note - for Altair2 we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of altair2 coming in to a transaction
