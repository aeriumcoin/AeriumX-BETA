Contributing to Altair2 Core
============================

The Altair2 Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Altair2 Core project, and is not to be
confused with overall Altair2 Network Protocol consensus changes.

Whether a pull request is merged into Altair2 Core rests with the project merge
...
Patches that change Altair2 consensus rules are considerably more involved than
...
Where a patch set proposes to change the Altair2 consensus, it must have been
...
The project leader is the release manager for each Altair2 Core release.
