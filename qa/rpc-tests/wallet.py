...
#   c) node1 mines 32 blocks, so now node 0 has 60001atr, node 1 has 4250atr, node2 has none.
#   d) node0 sends 601 atr to node2, in two transactions (301 atr, then 300 atr).
