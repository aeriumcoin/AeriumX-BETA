...
RESOURCES += src/qt/altair2.qrc src/qt/altair2_locale.qrc

TRANSLATIONS += src/qt/locale/altair2_bg.ts \
                src/qt/locale/altair2_de.ts \
                src/qt/locale/altair2_en.ts \
                src/qt/locale/altair2_es.ts \
                src/qt/locale/altair2_fi.ts \
                src/qt/locale/altair2_fr.ts \
                src/qt/locale/altair2_it.ts \
                src/qt/locale/altair2_ja.ts \
                src/qt/locale/altair2_pl.ts \
                src/qt/locale/altair2_pt.ts \
                src/qt/locale/altair2_ru.ts \
                src/qt/locale/altair2_sk.ts \
                src/qt/locale/altair2_sv.ts \
                src/qt/locale/altair2_vi.ts \
                src/qt/locale/altair2_zh_CN.ts \
                src/qt/locale/altair2_zh_TW.ts
