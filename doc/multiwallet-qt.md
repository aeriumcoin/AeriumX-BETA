...
In order to support loading of multiple wallets in altair2-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is altair2.cpp.
...
Changes to altair2.cpp
----------------------
altair2.cpp is the entry point into altair2-qt, and as such, will require some minor modifications to provide hooks for
